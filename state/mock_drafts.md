...
**Generated:** 2026-03-23
**Thread ID:** N/A (mock)
**Attachment:** knowledge/images/gm_abs_part_number_stickers.png
...
Good news — we do have part number 68064938 in stock. You can find our listing here: https://www.ebay.com/itm/4804622680149

We can program some of these units. Once you are in the listing it will indicate if programming is available. If it is, you can enter your VIN and mileage in the "Add note to seller" box during checkout.
...
3. We noted the issues are windows and 4x4 not working — is there anything else going on with the vehicle?
...
We did check our inventory for a replacement, but we do not have a 68320918 in stock at this time.

We would like to get a little more information from you to see if we can figure out what is going on. When you have a free moment if you could please let us know the following:
...
---
Hello Mark, thanks for reaching out!

We did check our inventory for a replacement, but we do not have a F81B-14B205-FB in stock at this time.

We do offer a repair and return service for some Ford GEM modules. Unfortunately not all of these units are repairable. This is the reason we ask for so much information up front as we do have a diagnostic fee of $94.99 that we would refund you down to if the unit comes in and either tests good or winds up being unrepairable. We do not want you to send it to us unless we have a good shot at a successful repair.

If repair and return is still the way you want to go, we still need a couple of things before we can let you know if we believe a repair is possible:

1. What engine is in the 1999 F-550?
2. We noted the multi-function switch has been replaced and wiring from the switch to the BCM and BCM to the fuse box has been checked — has anything else been repaired or replaced in an attempt to fix the issue?
